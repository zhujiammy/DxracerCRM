...
public class CollectionReceiptFragment extends Fragment implements PublicInterface.View {

    //收款单据
    private View view;
    public RecyclerViewEmptySupport recyclerView;
    public RefreshLayout refreshLayout;
    private CollectionReceiptFragmentPresenter presenter;
    public CollectionReceiptFragmentAdapter adapter;
    public static final int  INTENT=1004;
    public String contractNo;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.collectionreceiptfragment,container,false);
        presenter = new CollectionReceiptFragmentPresenter(this,this);
        initUI();
        return view;
