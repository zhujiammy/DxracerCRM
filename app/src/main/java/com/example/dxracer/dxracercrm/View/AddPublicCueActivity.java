...
public class AddPublicCueActivity extends AppCompatActivity implements AddPublicCueInterface.View {

    private AddPublicCuePresenter presenter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initUI();
        presenter = new AddPublicCuePresenter(this,this);
