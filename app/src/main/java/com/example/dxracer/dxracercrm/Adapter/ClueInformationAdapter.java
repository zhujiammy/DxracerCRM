...
public class ClueInformationAdapter extends RecyclerView.Adapter implements View.OnClickListener {

    private ClueInformationFragment context;
    private  List<PublicCueMode.Bean> data;
    public static final int VIEW_TYPE_ITEM = 1;
    public static final int VIEW_TYPE_EMPTY = 0;
    public ClueInformationAdapter(List<PublicCueMode.Bean> data, ClueInformationFragment context){
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ...
        ((lineViewHolder) holder).edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context.getActivity(),AddPrivateCueActivity.class);
        ...
        //更多
        ((lineViewHolder)holder).more_btn.setVisibility(View.GONE);
    }
