...
public class NetUtils {
    ...
    /**
     * post请求，异步方式，提交数据，是在子线程中执行的，需要切换到主线程才能更新UI、带addHeader
     * @param url
     * @param bodyParams
     * @param myNetCall
     */
    public  void postDataAsynToNetHeader(String url, Map<String,String> bodyParams, final MyNetCall myNetCall) {
        //1构造RequestBody
        RequestBody body=setRequestBody(bodyParams);
        //2 构造Request
        Request.Builder requestBuilder = new Request.Builder();
