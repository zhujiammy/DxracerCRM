...
import com.example.dxracer.dxracercrm.Presenter.ContactsFragment1Presenter;
...
public class ContactsFragment1 extends Fragment implements MaillistInterface.View {

    //通讯录

    private ContactsFragment1Presenter presenter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        presenter = new ContactsFragment1Presenter(this,this);
        presenter.fetchData();
        initView();
        return view;
    }
    ...
    public void onAttach(Context context) {
        ...
        leadNo = ((ClueDetailsActivity)context).getleadNo();
    }
