...
public class CommunicationRecord1Adapter extends RecyclerView.Adapter implements View.OnClickListener {
    //数据源
    private List<CommunicationRecordModel.Recor> data;
    public static final int VIEW_TYPE_ITEM = 1;
    public static final int VIEW_TYPE_EMPTY = 0;
    public CommunicationRecordFragment communicationRecordActivity;
    //构造函数
    public CommunicationRecord1Adapter(List<CommunicationRecordModel.Recor> dataList,CommunicationRecordFragment communicationRecordActivity) {
        this.data = dataList;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        if (viewHolder instanceof BodyViewHolder) {
            ...
            ((BodyViewHolder) viewHolder).edit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    //编辑沟通记录
                    Intent intent = new Intent(communicationRecordActivity.getActivity(),AddRecordActivity.class);
